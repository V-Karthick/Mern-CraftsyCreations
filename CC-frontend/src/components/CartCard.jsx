...
const CartCard = ({email, id, image, title, description, price }) => {
  ...
  // );
  return (
  <div className="shadow-md rounded-lg p-6 flex flex-row justify-between group transform transition-all hover:-translate-y-2 bg-black hover:bg-[#1a1a1a] w-full">
    ...
    <div className="w-2/3 pl-6 flex flex-col justify-between">
      <div>
        ...
        {/* Description */}
        <p className="text-gray-300 group-hover:text-white mb-0">{description}</p>
      ...
      <div className="flex justify-end mt-2 items-end">
        <button
          ...
          className="text-black font-bold py-2 px-4 rounded bg-yellow-400 hover:bg-yellow-500"
        >
          REMOVE FROM CART
        </button>
      </div>
